 ...
 */
package net.flamily.irs.robot.robot_listenining;
...
import net.flamily.irs.robot.R;
...
public class SpeechService extends Service {
    ...
    public void startRecognizing(int sampleRate) {
        if (mApi == null) {
            Log.d(TAG, "API not ready. Ignoring the request.");
            return;
        }
        // Configure the API
        Log.e(TAG, "Configure the API and setting TLS");
    ...
    public void recognizeInputStream(InputStream stream) {
        try {
            Log.e(TAG, "recogniseInputStream");
            mApi.recognize(
    ...
    private class AccessTokenTask extends AsyncTask<Void, Void, AccessToken> {
        ...
        protected void onPostExecute(AccessToken accessToken) {
            ...
            /*OkHttpChannelBuilder managedChannelBuilder = OkHttpChannelBuilder.forAddress(HOSTNAME, PORT);
            managedChannelBuilder.sslSocketFactory(new NoSSLv3SocketFactory());
